...
class AppColors {
  static const dark = AurexPalette(
    ...
    accentStrong: Color(0xFFA78BFA),
    accentSoft: Color(0x2E2DD4BF),
    glow: Color(0x4DA78BFA),
    ...
    ambientTopGlow: Color(0x242DD4BF),
    ambientRightGlow: Color(0x22A78BFA),
    ambientBottomGlow: Color(0x1CF472B6),
  );
  ...
  static const light = AurexPalette(
    ...
    accent: Color(0xFF0F9F8E),
    accentStrong: Color(0xFF7C3AED),
    accentSoft: Color(0x1F0F9F8E),
    ...
    ambientTopGlow: Color(0x240F9F8E),
    ambientRightGlow: Color(0x1F7C3AED),
    ambientBottomGlow: Color(0x1AF43F5E),
  );
